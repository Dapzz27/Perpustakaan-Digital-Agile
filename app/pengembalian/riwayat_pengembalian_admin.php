        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navMenu">
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../buku/data_buku.php">Buku</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="data_pengembalian_admin.php">Pengembalian</a></li>
                        </ul>
                    </li>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                if (mysqli_num_rows($query) == 0) {
                                    echo "<p class='text-center text-muted'>Belum ada data pengembalian.</p>";
                                }
