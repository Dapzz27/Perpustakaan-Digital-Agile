...
$query = mysqli_query($koneksi, "
    ...
    WHERE u.username = '$username_login'
                ...
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="daftar_peminjaman.php">Peminjaman</a>
                            </li>
                            <li><a class="dropdown-item"
                                    href="../Pengembalian/riwayat_pengembalian.php">Pengembalian</a></li>
                        </ul>
                    </li>
