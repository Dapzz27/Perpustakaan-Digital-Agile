                ...
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="formPeminjaman/daftar_peminjaman.php">Peminjaman</a></li>
                            <li><a class="dropdown-item" href="pengembalian/riwayat_pengembalian.php">Pengembalian</a>
                            </li>
                        </ul>
                    </li>
